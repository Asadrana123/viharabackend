/**
 * renovationCosts/turlock_pedras.js
 *
 * 100 Pedras Rd, Turlock, CA 95382 — Single Family, 3bd/1ba, 1684 sqft, built 1962.
...
const TURLOCK_PEDRAS_PROPERTY_ID = '6a8d93884e6a9f474a016859';

const config = {
  "meta": {
    "address": "100 Pedras Rd, Turlock, CA 95382",
    "city": "Turlock",
    "state": "California",
    "squareFootage": 1684,
    "bedrooms": 3,
  ...
  "areas": {
    "Exterior": {
      ...
      "architecturalElements": {
        ...
        "Update roof/siding": {
          ...
          "contingency": {
            "percentage": 16,
            "reason": "Concealed moisture, rot, or sheathing damage risk — aging mechanical systems and possible galvanized plumbing in a 1962 build. California permit required."
          },
          "roiNote": {
        ...
        "New windows": {
          ...
          "contingency": {
            "percentage": 13,
            "reason": "Rough-opening rot and out-of-square framing risk on a 1962 build. California permit required."
          },
          "roiNote": {
      ...
      "focusAreas": {
        ...
        "All": {
          ...
          "contingency": {
            "percentage": 16,
            "reason": "Multi-trade coordination and full-scope permitting — aging mechanical systems and possible galvanized plumbing in a 1962 build. California permit required."
          },
          "roiNote": {
    ...
    "Kitchen": {
      ...
      "contingency": {
        "percentage": 13,
        "reason": "Plumbing and electrical updates often needed — aging mechanical systems and possible galvanized plumbing in a 1962 build. California permit required."
      },
      "roiNote": {
    ...
    "Bathroom": {
      ...
      "contingency": {
        "percentage": 16,
        "reason": "Bathroom rough-in and waterproofing risk — aging mechanical systems and possible galvanized plumbing in a 1962 build. California permit required."
      },
      "roiNote": {
    ...
    "Living Room": {
      ...
      "contingency": {
        "percentage": 11,
        "reason": "Possible electrical and permit needs; aging mechanical systems and possible galvanized plumbing in a 1962 build."
      },
      "roiNote": {
    ...
    "Bedroom": {
      ...
      "contingency": {
        "percentage": 11,
        "reason": "Minor electrical or permit work possible; aging mechanical systems and possible galvanized plumbing in a 1962 build."
      },
      "roiNote": {
...
module.exports = { id: TURLOCK_PEDRAS_PROPERTY_ID, config, TURLOCK_PEDRAS_PROPERTY_ID };
