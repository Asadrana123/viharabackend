...
async function sweepDueCalls() {
  ...
  try {
    ...
    for (const lead of due) {
      ...
      // push the rest to the next slot so they don't pile up.
...
function startGeorgiaStCallScheduler() {
  ...
  console.log("[gsa-daily] scheduler started — daily 11:00 AM / 2:30 PM / 6:00 PM local callbacks (per-minute sweep).");
  return task;
}
