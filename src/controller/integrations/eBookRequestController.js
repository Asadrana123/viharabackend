...
const EbookRequest = require("../../model/integrations/EBookModel");
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p><a href="https://www.vihara.ai/resources/distressed-properties-guide.pdf" class="button">Download Your E-Book</a></p>
            <p>Happy investing!</p>
            <p>The Vihara Team</p>
          </div>
          <div class="footer">
