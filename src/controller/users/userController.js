...
const userPreferencesModel = require('../../model/users/userPreferencesModel.js')
const savedSearches = require('../../model/property/savedSearch.js')
const Form = require("../../model/users/formDataModel");
...
const createPasswordResetEmail =require('../../htmlPages/users/passwordResetEmail.js');
const createWelcomeEmail=require('../../htmlPages/users/welcomeEmail.js');
