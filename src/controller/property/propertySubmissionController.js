...
const createRealtorSubmissionReceivedEmail = require("../../htmlPages/users/realtorSubmissionReceivedEmail");
const createRealtorSubmissionApprovedEmail = require("../../htmlPages/users/realtorSubmissionApprovedEmail");
const createRealtorSubmissionChangesRequestedEmail = require("../../htmlPages/users/realtorSubmissionChangesRequestedEmail");
const createRealtorSubmissionRejectedEmail = require("../../htmlPages/users/realtorSubmissionRejectedEmail");
