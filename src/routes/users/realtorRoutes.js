...
const {
  ...
  loginRealtor,
  logoutRealtor,
  forgotPasswordRealtor,
  resetPasswordRealtor,
  getRealtorMe,
  ...
  getMyRequests,
  sharePropertyLink
} = require("../../controller/users/realtorController");
const {
  createSubmission,
  updateSubmission,
  submitSubmission,
  ...
  getMySubmission,
  deleteSubmission
} = require("../../controller/property/propertySubmissionController");
...
router.post("/forgot/password", forgotPasswordRealtor);
router.post("/password/reset/:token", resetPasswordRealtor);
