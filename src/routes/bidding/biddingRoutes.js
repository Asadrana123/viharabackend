...
const manualBiddingController = require("../../controller/bidding/manualBiddingController");
const autoBiddingController = require("../../controller/bidding/autoBiddingController");
